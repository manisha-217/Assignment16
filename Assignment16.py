...
db=py.connect("localhost","root","Manisha@123","Book")
...
cursor.execute("insert into book values(001,'looking for princess','switzerland','fiction')")
cursor.execute("insert into titles values(001,'looking for princess','1001',101,2005)")
cursor.execute("insert into publishers values(001,'unknown','switzerland',10002,11001)")
cursor.execute("insert into zip_code values(001,'jamui','bihar',123456)")
...
db=py.connect("localhost","root","Manisha@123","library")
cursor=db.cursor()
cursor.execute("select * from book")
result=cursor.fetchall()
print(result)
cursor.execute("update book set genre='barbie story' where book_id=101")
cursor.execute("select * from book")
result=cursor.fetchall()
print(result)
db.commit()
